...
export class Home extends Component {
  ...
  // @ts-ignore
    render() {
        ...
        return (
            <>
                <div className='cake flex justify-center items-center gap-44 bg-purple-200 from-fuchsia-200'>
                    <div className={'pl-32'}>
                        ...
                        <button className='bg-purple-400 rounded-full p-2 text-2xl mt-20' onClick={this.latestMenuList}>Latest Collection</button>
                    </div>
                    <div className={''}>
